...
from enums import LLMChatResponseStatusEnum
from implementations import LLMServiceImpl
    ...
    async def Chat(self, modelParams: LLMChatModel) -> LLMChatResponseModel:
        try:
            async with AsyncCerebras(
                ...
                return LLMChatResponseModel(status=LLMChatResponseStatusEnum.SUCCESS)
